...
#For DTP3
TotChild <- vaxdat$dtp3_Tot
TotVax   <- vaxdat$dtp3_Vax
...
cat("r-squared for dtp3 are:", r2, sep="  ", "\n")
cat("Selected covariates for dtp3 are:", covnames, sep="  ", "\n")
cat("VIF values of selected covariates for dtp3 are:", vif(fit), sep="  ", "\n")
cat("P-values of selected covariates for dtp3 are:", p.values, sep="  ", "\n")
